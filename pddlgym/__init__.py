...
from pddlgym.text_rendering import *
...
for env_name, kwargs in [
        ...
        ("blocks_easy", {'render' : blocks_render, 'text_render' : blocks_text_render}),
        ("derivedblocks", {'render' : blocks_render, 'text_render' : blocks_text_render}),
        ("toomanyblocks", {'render' : blocks_render, 'text_render' : blocks_text_render}),
        ("lifelong_blocks6", {'render' : blocks_render, 'text_render' : blocks_text_render}),
        ("travel", {}),
        ...
        ("footwear", {'operators_as_actions' : True,
                      'dynamic_action_space' : True}),
        ("easyblocks", {'render' : blocks_render, 'text_render' : blocks_text_render}),
        ("conditionalblocks", {'render' : blocks_render, 'text_render' : blocks_text_render}),
        ("conditionalferry", {}),
        ("blocks_operator_actions", {'render' : blocks_render, 'text_render' : blocks_text_render,
                                     'operators_as_actions' : True,
                                     'dynamic_action_space' : True}),
        ("generated_blocks", {'render' : blocks_render, 'text_render' : blocks_text_render,
                              'operators_as_actions' : True,
                              'dynamic_action_space' : True}),
        ("blocks_medium", {'render' : blocks_render, 'text_render' : blocks_text_render,
                           'operators_as_actions' : True,
                           'dynamic_action_space' : True}),
        ("manyblocksnopiles", {'render' : blocks_render, 'text_render' : blocks_text_render,
                               'operators_as_actions' : True,
                               'dynamic_action_space' : True}),
        ("manyexplodingblockssmallpiles", {'render' : blocks_render, 'text_render' : blocks_text_render,
                                           'operators_as_actions' : True,
                                           'dynamic_action_space' : True}),
        ("manyblockssmallpiles", {'render' : blocks_render, 'text_render' : blocks_text_render,
                                  'operators_as_actions' : True,
                                  'dynamic_action_space' : True}),
        ("manyblockssmallpilesnoclear", {'render' : blocks_render, 'text_render' : blocks_text_render,
                                  'operators_as_actions' : True,
                                  'dynamic_action_space' : True}),
        ("manyblockssmallpilesnohand", {'render' : blocks_render, 'text_render' : blocks_text_render,
                                  'operators_as_actions' : True,
                                  'dynamic_action_space' : True}),
        ("manyblockssmallpilesnoclearhand", {'render' : blocks_render, 'text_render' : blocks_text_render,
                                  'operators_as_actions' : True,
                                  'dynamic_action_space' : True}),
        ("quantifiedblocks", {'render' : blocks_render, 'text_render' : blocks_text_render,
                              'operators_as_actions' : True,
                              'dynamic_action_space' : True}),
        ("quantifiedblocks2", {'render' : blocks_render, 'text_render' : blocks_text_render,
                               'operators_as_actions' : True,
                               'dynamic_action_space' : True}),
        ("quantifiedblocks3", {'render' : blocks_render, 'text_render' : blocks_text_render,
                               'operators_as_actions' : True,
                               'dynamic_action_space' : True}),
        ...
        ("movie", {'operators_as_actions' : True,
                   'dynamic_action_space' : True}),
        ("glibblocks", {'render' : blocks_render, 'text_render' : blocks_text_render}),
